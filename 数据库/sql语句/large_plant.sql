...
-- ----------------------------
-- Table structure for large_plant
-- ----------------------------
DROP TABLE IF EXISTS `large_plant`;
CREATE TABLE `large_plant`  (
  ...
  `largePlantName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '大型植物名称',
  `largePlantCode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '大型植物编号',
