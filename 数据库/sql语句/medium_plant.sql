...
-- ----------------------------
-- Table structure for medium_plant
-- ----------------------------
DROP TABLE IF EXISTS `medium_plant`;
CREATE TABLE `medium_plant`  (
  ...
  `mediumPlantName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '中型植物名称',
  `mediumPlantCode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '中型植物编号',
