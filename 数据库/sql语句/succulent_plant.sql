...
-- ----------------------------
-- Table structure for succulent_plant
-- ----------------------------
DROP TABLE IF EXISTS `succulent_plant`;
CREATE TABLE `succulent_plant`  (
  ...
  `succulentPlantName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '多肉植物名称',
  `succulentPlantCode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '多肉植物编号',
