...
public class SucculentPlant {
  ...
  @ApiModelProperty(value = "多肉植物名称")
  private String succulentPlantName;
  @ApiModelProperty(value = "多肉植物编号")
  private String succulentPlantCode;
  @ApiModelProperty(value = "多肉植物图片")
  private String succulentPlantImage;
