...
public class MediumPlant {
  ...
  @ApiModelProperty(value = "中型植物名称")
  private String mediumPlantName;
  @ApiModelProperty(value = "中型植物编号")
  private String mediumPlantCode;
  @ApiModelProperty(value = "中型植物图片")
  private String mediumPlantImage;
