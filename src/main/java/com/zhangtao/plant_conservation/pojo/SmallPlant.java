...
public class SmallPlant {
  ...
  @ApiModelProperty(value = "小型植物名称")
  private String smallPlantName;
  @ApiModelProperty(value = "小型植物编号")
  private String smallPlantCode;
  @ApiModelProperty(value = "小型植物图片")
  private String smallPlantImage;
